...
// Récupérer les produits déjà ajoutés
$produitsAjoutes = []; // Tableau pour stocker les IDs des produits déjà ajoutés

// Si des produits ont été ajoutés, les stocker dans le tableau
if (isset($_POST['produit_id'])) {
    $produitsAjoutes = $_POST['produit_id'];
}
            ...
            <div class="produit-ligne">
                <select name="produit_id[]" class="produit-select">
                    ...
                    <?php foreach ($produits as $produit):
                        ...
                        if (in_array($produit['produit_id'], $produitsAjoutes)) continue; // Ignore les produits déjà ajoutés
                    ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('venteForm').addEventListener('submit', function(e) {
                ...
                function verifierNumeroCheque() {
                    ...
                    return true; // Si le paiement par chèque n'est pas sélectionné, la vérification est considérée comme réussie
                }
                ...
                ordonnanceLignes.forEach(ligne => {
                    const ordonnanceFields = ligne.querySelector('.ordonnance-fields');
                    if (ordonnanceFields.style.display === 'block') {
                        ...
                        if (!numeroOrdonnance || !numeroOrdre) {
                ...
                if (!ordonnanceValide) {
                    e.preventDefault();
                    alert("Le numéro d'ordonnance et le numéro d'ordre ne peuvent pas être vides.");
                    return;
                }
                ...
                //  un champ caché pour les modes de paiement sélectionnés
