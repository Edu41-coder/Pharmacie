<?php
$pageTitle = "Montant Total des Commandes Livrées";
...
$montantTotalCommandesLivrees = $commandeObj->getMontantTotalCommandesLivrees($dateDebut, $dateFin);
?>

<div class="container">
    <div class="main-box">
        <h1>Montant Total des Commandes Livrées</h1>
        ...
        <form method="GET" action="" class="mb-4">
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
                    <button type="submit" class="btn btn-primary form-control">Calculer le total</button>
                </div>
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
        ...
        <div class="alert alert-info">
            <?php if ($dateDebut && $dateFin): ?>
                <p>Montant total des commandes livrées entre le <?php echo $dateDebut; ?> et le <?php echo $dateFin; ?> :</p>
            <?php else: ?>
                <p>Montant total de toutes les commandes livrées :</p>
            <?php endif; ?>
            <h3><?php echo number_format($montantTotalCommandesLivrees, 2, ',', ' '); ?> €</h3>
        </div>
