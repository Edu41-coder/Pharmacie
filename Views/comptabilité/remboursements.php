<?php
$pageTitle = "Calcul des Remboursements";
...
$montantTotalRemboursements = $venteObj->getMontantTotalRemboursements($dateDebut, $dateFin);
?>

<div class="container">
    <div class="main-box">
        <h1>Calcul des Remboursements</h1>
        ...
        <form method="GET" action="" class="mb-4">
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
                    <button type="submit" class="btn btn-primary form-control">Calculer les remboursements</button>
                </div>
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
        ...
        <div class="alert alert-info">
            <?php if ($dateDebut && $dateFin): ?>
                <p>Montant total à rembourser entre le <?php echo $dateDebut; ?> et le <?php echo $dateFin; ?> :</p>
            <?php else: ?>
                <p>Montant total à rembourser pour toutes les ventes :</p>
            <?php endif; ?>
            <h3><?php echo number_format($montantTotalRemboursements, 2, ',', ' '); ?> €</h3>
        </div>
