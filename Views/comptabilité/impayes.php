...
$montantTotalImpayes = $venteObj->getMontantTotalChequesImpayes($dateDebut, $dateFin);
?>
    ...
    <div class="main-box">
        ...
        <form method="GET" action="" class="mb-4">
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
                    <button type="submit" class="btn btn-primary form-control">Calculer les impayés</button>
                </div>
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
        ...
        <div class="alert alert-info">
            <?php if ($dateDebut && $dateFin): ?>
                <p>Montant total des chèques impayés entre le <?php echo $dateDebut; ?> et le <?php echo $dateFin; ?> :</p>
            <?php else: ?>
                <p>Montant total des chèques impayés pour toutes les ventes :</p>
            <?php endif; ?>
            <h3><?php echo number_format($montantTotalImpayes, 2, ',', ' '); ?> €</h3>
        </div>
